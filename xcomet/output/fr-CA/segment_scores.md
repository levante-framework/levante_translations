...
| --- | --- | --- | --- |
| general-rotate-device | Please rotate your device for the best view of the activities. | Veuillez pivoter votre appareil pour obtenir la meilleure vue des activités. | 0.8679026365280151 |
| general-device-type | Please use a tablet in landscape mode, or a desktop computer or a laptop to complete the activities. | Veuillez utiliser une tablette en mode paysage, un ordinateur de bureau ou un ordinateur portable pour réaliser les activités. | 0.8749531507492065 |
...
| feedback-not-quite-right | That's not quite right. Please try again. | Ce n'est pas correct. Essayez encore. | 0.869110107421875 |
...
| task-completion | You've completed this game. Thank you! | Tu as terminé le jeu. Merci ! | 0.8892079591751099 |
| general-your-turn | Nice job with the practice! Let's try some more on your own. | Beau travail avec la pratique ! Essayons-en plus de ton côté. | 0.6316601037979126 |
...
| hearts-and-flowers-try-again | That's not quite right. Please try again. | Ce n'est pas correct. Essayez encore. | 0.869110107421875 |
...
| bluestack | The large blue stack | La grande pile bleue | 0.8368233442306519 |
| redstack | The medium sized red stack | La pile rouge de taille moyenne | 0.8066756725311279 |
| yellowstack | The small yellow stack | La petite pile jaune | 0.8372831344604492 |
...
| ToM-scene-18-instruct1 | George and Kat are playing together. They look outside and see a new toy shop across the street. Kat decides to go buy some new toys at the toy shop. Kat asks George what toy he would like to have, and George says he would like a new basketball. | George et Kat jouent ensemble. Ils regardent dehors et voient un nouveau magasin de jouets de l'autre côté de la rue. Kat décide d'aller acheter de nouveaux jouets au magasin de jouets. Kat demande à George quel jouet il aimerait avoir, et George dit qu'il aimerait un nouveau ballon de basketball. | 0.8851402401924133 |
...
| sds-your-turn | Now it's your turn! | À ton tour maintenant ! | 0.870491087436676 |
| sds-prompt3-demo-heavy | Here is another picture. I have to choose which of these pictures is the same as this new picture. | Voici une autre image. Je dois choisir laquelle de ces images est identique à cette nouvelle image. | 0.880374550819397 |
| sds-pick-square-demo-heavy | I will pick this one! This one is the same as the new picture because they are both squares. | Je vais choisir celle-ci ! Celle-ci est identique à la nouvelle image car elles sont toutes deux des carrés. | 0.8558405637741089 |
| same-different-selection-instruct1-heavy | This is the matching game. In this game, we are going to look at pictures and find things about them that are the same in some way. | Ceci est le jeu de correspondance. Dans ce jeu, nous allons regarder des images et trouver des éléments qui sont les mêmes d'une certaine façon. | 0.8002616763114929 |
| same-different-selection-instruct2-heavy | Now we're going to look at more pictures and find things about them that are the same. Let's learn how to play! | Maintenant, nous allons regarder d'autres images et trouver des éléments qui sont les mêmes. Apprenons à jouer ! | 0.8498402833938599 |
| same-different-selection-instruct3-heavy | Now you're going to play the rest of the game on your own! | Maintenant, tu vas jouer le reste du jeu tout seul ! | 0.875523030757904 |
| same-different-selection-instruct4-heavy | Now we're going to try something new! You're going to find pairs of shapes that are the same in some way. Let's learn how! | Maintenant, nous allons essayer quelque chose de nouveau ! Tu vas chercher des paires de formes qui sont les mêmes d'une certaine façon. Apprenons comment faire ! | 0.8508607745170593 |
| same-different-selection-instruct5-heavy | Here are three pictures. I have to choose 2 of them that are the same in some way. I will pick these 2 pictures because they are both triangles. | Voici trois images. Je dois choisir 2 d'entre elles qui sont les mêmes d'une certaine façon. Je vais choisir ces 2 images car elles sont toutes deux des triangles. | 0.8834593296051025 |
| same-different-selection-instruct6-heavy | Here are the same three pictures. I have to choose 2 of them that are the same in a different way. I will pick these 2 pictures because they are both red. | Voici les mêmes trois images. Je dois choisir 2 d'entre elles qui sont les mêmes d'une manière différente. Je vais choisir ces 2 images car elles sont toutes deux rouges. | 0.8886391520500183 |
| same-different-selection-touch-circle-heavy | Show me the circle. | Montre-moi le cercle. | 0.8553165197372437 |
| same-different-selection-touch-square-heavy | Show me the square. | Montre-moi le carré. | 0.8329548835754395 |
| same-different-selection-touch-triangle-heavy | Show me the triangle. | Montre-moi le triangle. | 0.8561119437217712 |
| same-different-selection-touch-star-heavy | Show me the star. | Montre-moi l'étoile. | 0.8655568361282349 |
| same-different-selection-touch-green-heavy | Show me the green one. | Montre-moi le vert. | 0.8520772457122803 |
| same-different-selection-touch-red-heavy | Show me the red one. | Montre-moi le rouge. | 0.8376818895339966 |
| same-different-selection-touch-blue-heavy | Show me the blue one. | Montre-moi le bleu. | 0.8478357791900635 |
| same-different-selection-touch-yellow-heavy | Show me the yellow one. | Montre-moi le jaune. | 0.8470643162727356 |
| same-different-selection-touch-small-heavy | Show me the small one. | Montre-moi le petit. | 0.8424252271652222 |
| same-different-selection-touch-medium-heavy | Show me the medium one. | Montre-moi le moyen. | 0.7839346528053284 |
| same-different-selection-touch-large-heavy | Show me the large one. | Montre-moi le grand. | 0.8023002743721008 |
| same-different-selection-touch-white-heavy | Show me the picture with the white background. | Montre-moi l'image avec le fond blanc. | 0.8642750978469849 |
| same-different-selection-touch-gray-heavy | Show me the picture with the gray background. | Montre-moi l'image avec le fond gris. | 0.8633031845092773 |
| same-different-selection-touch-black-heavy | Show me the picture with the black background. | Montre-moi l'image avec le fond noir. | 0.8616381883621216 |
| same-different-selection-touch-striped-heavy | Show me the picture with the striped background. | Montre-moi l'image avec le fond rayé. | 0.8559121489524841 |
| same-different-selection-touch-1-heavy | Show me the picture with one shape. | Montre-moi l'image avec une forme. | 0.7438924908638 |
| same-different-selection-touch-2-heavy | Show me the picture with two shapes. | Montre-moi l'image avec deux formes. | 0.8207393288612366 |
| same-different-selection-touch-3-heavy | Show me the picture with three shapes. | Montre-moi l'image avec trois formes. | 0.8306640386581421 |
| same-different-selection-touch-4-heavy | Show me the picture with four shapes. | Montre-moi l'image avec quatre formes. | 0.8346061706542969 |
| same-different-selection-both-circles-heavy | Here are two pictures. Something's the same. They're both circles. | Voici deux images. Quelque chose est pareil. Ce sont tous deux des cercles. | 0.8557601571083069 |
| same-different-selection-both-squares-heavy | Here are two pictures. Something's the same. They're both squares. | Voici deux images. Quelque chose est pareil. Ce sont tous deux des carrés. | 0.8414126634597778 |
| same-different-selection-both-triangles-heavy | Here are two pictures. Something's the same. They're both triangles. | Voici deux images. Quelque chose est pareil. Ce sont tous deux des triangles. | 0.851941704750061 |
| same-different-selection-both-red-heavy | Here are two pictures. Something's the same. They're both red. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux rouges. | 0.8684954643249512 |
| same-different-selection-both-green-heavy | Here are two pictures. Something's the same. They're both green. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux vertes. | 0.8696297407150269 |
| same-different-selection-both-yellow-heavy | Here are two pictures. Something's the same. They're both yellow. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux jaunes. | 0.8742016553878784 |
| same-different-selection-both-blue-heavy | Here are two pictures. Something's the same. They're both blue. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux bleues. | 0.8709622025489807 |
| same-different-selection-both-small-heavy | Here are two pictures. Something's the same. They're both small. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux petites. | 0.824169397354126 |
| same-different-selection-both-medium-heavy | Here are two pictures. Something's the same. They're both medium. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux moyennes. | 0.8005433678627014 |
| same-different-selection-both-large-heavy | Here are two pictures. Something's the same. They're both large. | Voici deux images. Quelque chose est pareil. Elles sont toutes deux grandes. | 0.8070306181907654 |
| sds-prompt3-heavy | Here is another picture. Which of these pictures is the same as this new picture? | Voici une autre image. Laquelle de ces images est identique à cette nouvelle image ? | 0.8843958973884583 |
| sds-3match-prompt2-heavy | Here are the same pictures. Choose two of them that are the same in a different way. | Voici les mêmes images. Choisissez deux d'entre elles qui sont identiques d'une manière différente. | 0.8712887167930603 |
| sds-2match-prompt1-heavy | Here are some new pictures. Choose two of them that are the same in some way. | Voici de nouvelles images. Choisis deux d'entre elles qui sont les mêmes d'une certaine façon. | 0.877342939376831 |
| sds-2match-prompt2-heavy | Now choose two pictures that are the same in a different way. | Choisis maintenant deux images qui sont les mêmes d'une manière différente. | 0.8581931591033936 |
| sds-3unique-prompt1-heavy | Choose three pictures that are the same in only one way. | Choisis trois images qui sont les mêmes d'une seule façon. | 0.8634771108627319 |
| sds-3unique-prompt2-heavy | Choose another three pictures that are the same in only one way. | Choisis trois autres images qui sont les mêmes d'une seule façon. | 0.8654501438140869 |
| sds-match-demo1-heavy | Here are three pictures. I have to choose two of them that are the same in some way. I will pick these two pictures because they are both triangles. | Voici trois images. Je dois choisir deux d'entre elles qui sont les mêmes d'une certaine façon. Je vais choisir ces deux images car elles sont toutes deux des triangles. | 0.8844727277755737 |
| sds-match-demo2-heavy | Here are the same three pictures. I have to choose two of them that are the same in a different way. I will pick these two pictures because they are both small. | Voici les mêmes trois images. Je dois choisir deux d'entre elles qui sont les mêmes d'une manière différente. Je vais choisir ces deux images car elles sont toutes deux petites. | 0.8837177753448486 |
| data-questionnaire-button-text1 | I have SERIOUS CONCERNS about these data (e.g., the child did not seem to understand the task, was frequently distracted/interrupted, etc.) | J'ai de SÉRIEUX DOUTES concernant ces données (par exemple, l'enfant ne semblait pas comprendre la tâche, était souvent distrait/interrompu, etc.) | 0.8791846036911011 |
| data-questionnaire-button-text2 | I feel OK about these data (e.g., the child seemed to understand the task pretty well, only experienced a few distractions/interruptions, etc.) | Je me sens correct(e) à propos de ces données (par exemple, l'enfant semblait bien comprendre la tâche, a subi quelques distractions/interruptions, etc.) | 0.7484110593795776 |
| data-questionnaire-button-text3 | I feel GOOD about these data (e.g., the child clearly understood the task, had very few (if any) distractions/ interruptions, etc.) | Je me sens BIEN à propos de ces données (par exemple, l'enfant a clairement compris la tâche, a eu très peu (voire pas) de distractions/interruptions, etc.) | 0.8632851243019104 |
| math-instructions1-heavy | In this game, you will play with numbers.  Some questions might be easy for you and some might be hard. That is okay! Please try your best and take your time. Let’s get started! | Dans ce jeu, tu joueras avec des nombres.  Certaines questions pourraient être faciles pour toi et d'autres difficiles. Ce n'est pas grave ! Essaie de faire de ton mieux et prends ton temps. Commençons ! | 0.881506085395813 |
| math-intro1-heavy | It's time for the first number game! Let's practice. | Il est temps pour le premier jeu de chiffres ! Pratiquons. | 0.8386526107788086 |
| math-intro2-heavy | It's time for the next number game! Let's practice. | Il est temps pour le prochain jeu de chiffres ! Pratiquons. | 0.8303704261779785 |
| counting-intro | In this number game, you will say how many things are in the picture! The grownup helping you will press the button. | Dans ce jeu de chiffres, tu diras combien d'objets se trouvent sur l'image ! L'adulte qui t'aide appuiera sur le bouton. | 0.8665323257446289 |
| counting-intro-afc | This time, you will choose the button with the right number! | Cette fois, tu choisiras le bouton avec le bon nombre ! | 0.8529242873191833 |
| memory-game-instruct1-heavy | This is the memory game. | Ceci est le jeu de mémoire. | 0.8416913151741028 |
| memory-game-instruct2-heavy | In this game, we are going to see squares light up. Your job is to touch the squares that light up. | Dans ce jeu, nous allons voir des carrés s'allumer. Ton travail consiste à toucher les carrés qui s'allument. | 0.8601129055023193 |
| memory-game-instruct3-heavy | Now we will see two squares light up. Your job is to touch the squares in the same order as they light up! | Maintenant, nous allons voir deux carrés s'allumer. Ton travail consiste à toucher les carrés dans le même ordre qu'ils s'allument ! | 0.8419002294540405 |
| memory-game-instruct4-heavy | Watch the squares light up. I will touch the squares in the same order. | Regarde les carrés s'allumer. Je vais toucher les carrés dans le même ordre. | 0.8414486646652222 |
| memory-game-instruct5-heavy | OK, now you're going to play the rest of the memory game on your own. More squares will light up each time the longer you play, so watch carefully! | D'accord, maintenant vous allez jouer le reste du jeu de mémoire seul. Plus de carrés s'allumeront à chaque fois plus vous jouerez longtemps, alors regardez attentivement ! | 0.8384523987770081 |
| memory-game-instruct6-heavy | If you make a mistake, just keep going! | Si vous faites une erreur, continuez! | 0.8634108304977417 |
| ns-number-identification-1 | Choose the card that shows 1 apple. | Choisissez la carte qui montre 1 pomme. | 0.8770700097084045 |
| ns-number-identification-2 | Choose the card that shows 2 cars. | Choisissez la carte qui montre 2 voitures. | 0.8715119361877441 |
| ns-number-identification-5 | Choose the card that shows 5 apples. | Choisissez la carte qui montre 5 pommes. | 0.8758598566055298 |
| ns-number-identification-7 | Choose the card that shows 7 cars. | Choisissez la carte qui montre 7 voitures. | 0.8733187913894653 |
| ns-number-identification-10 | Choose the card that shows 10 apples. | Choisissez la carte qui montre 10 pommes. | 0.8739129900932312 |
| counting-1 | How many cars is this? | Combien de voitures y a-t-il ? | 0.8563851118087769 |
| counting-2 | How many apples is this? | Combien de pommes y a-t-il ? | 0.8094831705093384 |
| ns-number-comp-1 | Which card has more apples? | Quelle carte a plus de pommes ? | 0.8593820929527283 |
| ns-number-comp-2 | Which card has more cars? | Quelle carte a plus de voitures ? | 0.8613388538360596 |
...
| --- | --- | --- | --- |
| general-rotate-device | Please rotate your device for the best view of the activities. | Por favor utiliza la tableta en modo horizontal para que las actividades se puedan visualizar correctamente. | 0.8238183259963989 |
| general-device-type | Please use a tablet in landscape mode, or a desktop computer or a laptop to complete the activities. | Por favor utiliza una tableta en modo horizontal, un ordenador de sobremesa o un portátil para que las actividades se puedan visualizar correctamente. | 0.7775641679763794 |
| general-intro1 | Hi! We are excited to have you play some games with us today! | ¡Hola! ¡Estamos encantados de que juegues hoy con nosotros! | 0.8855284452438354 |
| general-intro2 | First, you get to choose a buddy to play along with you. As you complete the different games, you will get to pick an accessory like a hat or glasses to decorate your buddy. | En primer lugar, tienes que elegir a un amigo para que juegue contigo. A medida que completes los diferentes juegos, podrás elegir un accesorio como un sombrero o unas gafas para decorar a tu amigo. | 0.8741826415061951 |
| pick-buddy | Pick a buddy to play with! | ¡Escoge un amigo para jugar! | 0.8697527647018433 |
| general-intro3 | Now that you have your buddy, we want to explain how the games work. | Ahora que ya tienes a tu amigo, queremos explicarte cómo funcionan los juegos. | 0.8753814697265625 |
| general-intro4 | During the games you will need to listen to instructions so make sure your speakers are on and the volume is the way you like it. If you need to hear the instructions again, you can click the speaker button up in the corner of your screen. | Durante los juegos tendrás que escuchar las instrucciones, así que asegúrate de que los altavoces están encendidos y el volumen está a tu gusto. Si necesitas volver a escuchar las instrucciones, presiona el botón del altavoz situado en la esquina superior de la pantalla. | 0.8825353980064392 |
| general-intro5 | You can choose your answers in different ways depending on the type of tablet or computer you are using. You can use a mouse or touchpad to click your choice, you can use the arrow keys on your keyboard, or you can touch your screen if you are using a tablet. You can pick the way that works best for you.  If you have any questions or need help getting started, please ask the adult who is nearby to help you. | Puedes elegir tus respuestas de diferentes maneras dependiendo del tipo de tableta u ordenador que estés utilizando. Puedes utilizar un ratón o un panel táctil para hacer clic en tu elección, puedes utilizar las teclas de flecha del teclado o puedes tocar la pantalla si utilizas una tableta. Puedes elegir la forma que más te convenga.<br><br>Si tienes alguna duda o necesitas ayuda para empezar, pide ayuda al adulto que esté cerca. | 0.8783628940582275 |
| task-finished | You've completed the game. Thank you! | Has completado el juego. ¡Gracias! | 0.8924007415771484 |
| continue-button-text | OK | OK | 0.827181875705719 |
| close-button-text | Close | Cerrar | 0.8278863430023193 |
| general-footer | Click the button below or press <b>ANY KEY</b> to continue | Haz clic en el botón abajo o presiona <b>CUALQUIER TECLA</b> para continuar | 0.8608715534210205 |
| instructions | instructions | instrucciones | 0.8420302867889404 |
| general-encourage | Keep Going! | ¡Continúa! | 0.8504337072372437 |
| feedbackCorrect | Great! That's right. | ¡Genial! Eso es correcto. | 0.8601816892623901 |
| feedback-not-quite-right | That's not quite right. Please try again. | Eso no está del todo bien. ¡Inténtalo de nuevo! | 0.8746042251586914 |
| feedback-try-again | Please try again! | ¡Inténtalo de nuevo! | 0.8806940913200378 |
| feedback-good-job | Good job! | ¡Bien hecho! | 0.8746013641357422 |
| feedback-nice-work | Nice work! | ¡Muy bien! | 0.7233190536499023 |
| replay-button | Press the speaker button if you want the question repeated. | Presiona el botón del altavoz si deseas que se repita la pregunta. | 0.8821276426315308 |
| general-fullscreen | Switch to full screen mode | Cambiar al modo de pantalla completa | 0.8624082207679749 |
| general-repeat-instructions | Looks like this is a little tricky! Let’s review the instructions. | ¡Parece que esto es un poco complicado! Repasemos las instrucciones. | 0.8755412101745605 |
| general-keyboard-instructions | If you want to use your keyboard to answer a question, press the arrow key shown next to your choice. | Si quieres usar el teclado para responder una pregunta, haz click en la flecha que ves al lado de la opción que quieres seleccionar. | 0.8794522881507874 |
| intro-finished | You've finished the instructions. Thank you! | Has terminado las instrucciones. ¡Gracias! | 0.8773064613342285 |
| general-exit | Exit | Salir | 0.8322522640228271 |
| task-completion | You've completed this game. Thank you! | Has completado el juego. ¡Gracias! | 0.891737699508667 |
| general-your-turn | Nice job with the practice! Let's try some more on your own. | ¡Buen trabajo en la práctica! Ahora intenta hacer unos ensayos por tu cuenta. | 0.7766796350479126 |
| matrix-reasoning-instruct1 | We’re going to show you a puzzle, and your job is to pick the best piece to complete the puzzle. Let's get started! | Vamos a mostrarte un rompecabezas. Tu tarea es elegir la mejor pieza para completarlo. ¡Empecemos! | 0.8818504214286804 |
| matrix-reasoning-instruct2 | See this big puzzle? It's missing a piece! Which piece goes in the puzzle? | ¿Ves este gran rompecabezas? Le falta una pieza. ¿Cuál pieza va en el rompecabezas? | 0.8539707660675049 |
| matrix-reasoning-prompt1 | Choose the best pattern to fill in the blank. | Escoge el mejor patrón para llenar el espacio en blanco. | 0.8531891107559204 |
| mental-rotation | Do you see these two outlines? One goes with this shape. Let’s see which one goes with the shape. | ¿Ves estas dos siluetas? Una va con esta figura. Veamos cuál va con la figura. | 0.7248362302780151 |
...
| math-instructions1 | In this game, you will do some math problems. Some will be like the ones you do in school and some will be a little different than what you do in school.   Some questions might be easy for you and some might be hard. That is okay! Please try your best and take your time. Most of the questions will have four choices. You choose the one you think is right. Let’s get started! | En este juego, harás algunos problemas de matemáticas. Algunos serán como los que haces en la escuela y otros serán un poco diferentes de los que haces en la escuela. <br><br>Algunas preguntas te resultarán fáciles y otras difíciles. ¡No pasa nada! Esfuérzate al máximo y tómate tu tiempo. La mayoría de las preguntas tienen cuatro opciones. Elige la que consideres correcta. ¡Empecemos! | 0.8828281164169312 |
...
| number-identification-10 | Choose the 23. | Escoge el 23. | 0.8492312431335449 |
...
| trog-item-2 | Choose the picture of the bird. | Escoge el dibujo del pájaro. | 0.8669533729553223 |
...
| trog-item-39 | the boys pick the apples | los niños recogen las manzanas | 0.8759823441505432 |
...
| trog-item-76 | the boy has neither hat nor shoes | el niño no tiene ni sombrero ni zapatos | 0.8814137578010559 |
...
| surprised | surprised | sorprendido | 0.8505927324295044 |
...
| ToM-scene6-instruct1 | Sam and Maria are playing together. They look outside and see a new shop across the street. Maria tells Sam: “I am going to buy new shirts for us there,” and she walks away. | Sam y María están jugando juntos. Cuando miran hacia afuera ven una tienda nueva al otro lado de la calle. María le dice a Sam: "voy a ir a comprar camisetas nuevas para nosotros" y se va. | 0.8824946880340576 |
| ToM-scene6-instruct2 | Mom comes home and she tells Sam that she just walked by the shop. “Are they selling shirts?” Sam asks. “No,” Mom says, “They are only selling shoes”. “Maria will probably now get shoes at the shop,” Sam says. | <br>Mamá llega a casa y le dice a Sam que acaba de pasar por la tienda. "¿Venden camisetas?" pregunta Sam. "No", dice Mamá, "solo venden zapatos". "Probablemente ahora María va a comprar zapatos en la tienda", dice Sam. | 0.8859471082687378 |
| ToM-scene6-q1 | Does Maria know that they are selling shoes in the shop? | <br>¿María sabe que en la tienda venden zapatos? | 0.8784481883049011 |
...
| hostile-attribution-scene3-instruct2 | You go to sharpen your pencil, and as you walk back to your desk there is a boy walking just in front of you. The boy passes your desk before you get there. | Te levantas para sacarle punta a tu lápiz y, de regreso a tu escritorio, vas detrás de un niño que camina justo delante de ti. El niño pasa por tu escritorio antes de que tú llegues. | 0.7529415488243103 |
...
| same-different-selection-both-circles | Here are two cards. Something's the same. They both have circles. | Aquí hay dos cartas. Son iguales en algo. Ambas tienen círculos. | 0.8679488897323608 |
...
| hearts-and-flowers-practice-time | Time to practice! | ¡Es hora de practicar! | 0.8771776556968689 |
...
| vocab-item-025 | the elbow | el codo | 0.8362412452697754 |
...
| vocab-item-062 | the sloth | el oso perezoso | 0.773373007774353 |
...
| vocab-item-099 | juggling | el malabarismo | 0.682013750076294 |
...
| vocab-item-136 | ecstatic | extático | 0.8114610910415649 |
...
| vocab-instruct-2 | Some words are hard, and that's okay. If you're not sure, just give your best guess! | Algunas palabras son difíciles, pero no te preocupes, si tienes dudas, ¡haz tu mejor intento! | 0.8513233661651611 |
...
| ToM-scene7-instruct2 | But while Diana was outside, someone did find it! And moved it from inside the drawer, to inside the desk. | Pero mientras Diana estaba fuera, ¡alguien lo encontró! Y lo movió del cajón al escritorio. | 0.8643507361412048 |
...
| ToM-scene-9-instruct1 | This is Mark. Mark is playing a really silly game today and not saying any words all day long. Instead, Mark is drawing pictures. Mark is at the library, deciding which book he would like to read. Mom shows Mark two books, a book about cups and a book about hills. | Este es Marco. Marco está jugando hoy un juego un poco loco en el que no dice ninguna palabra en todo el día. En vez de hablar, está haciendo dibujos. Marco está en la biblioteca, decidiendo qué libro le gustaría leer. La mamá le muestra a Marco dos libros: uno sobre tazas y otro sobre montañas. | 0.8719636797904968 |
...
| ToM-scene-9-q4-emotion_reasoning | Look, Mom realized her mistake and gave Mark the book he really wanted! How do you think Mark feels about getting the book he wanted? | Mira, la mamá se ha dado cuenta de su error y le ha dado a Marco el libro que él realmente quería. ¿Cómo crees que se siente Marco al recibir el libro que quería? | 0.8827973008155823 |
...
| ToM-scene-14-q4-false_belief | Is Bobby being mean and naughty for taking Anna’s soccer ball? | ¿Roberto está siendo necio y travieso por coger el balón de fútbol de Anna? | 0.832105278968811 |
| ToM-scene-14-q5-false_belief | Should Bobby get in trouble with their mom for taking Anna’s soccer ball? | ¿Debería Roberto estar en problemas con su madre por coger el balón de fútbol de Anna? | 0.8576385974884033 |
| ToM-scene-14-q6-reality_check | Can you help Anna find her soccer ball? Is it on the table or on the floor? | ¿Puedes ayudarle a Anna a encontrar su balón de fútbol? ¿Está sobre la mesa o en el suelo? | 0.8884412050247192 |
| ToM-scene-14-q7-reality_check | Can you help Bobby find his soccer ball? Is it on the table or on the floor? | ¿Puedes ayudarle a Roberto a encontrar su balón de fútbol? ¿Está sobre la mesa o en el suelo? | 0.8508691191673279 |
| ToM-scene-15-instruct1 | Alex, Beth, and Johnny are playing a game at the park. Here's how the game goes: One kid hides, but draws a clue in the sandbox so the other kids can find them. | Alex, Isabel y John están jugando un juego en el parque. En este juego uno de los niños se esconde, pero antes de esconderse, debe dibujar una pista en la arenera para que los otros puedan encontrarle. | 0.8234356641769409 |
| ToM-scene-15-instruct2 | Johnny decides to hide behind the flower bush. He draws a clue in the sand. Johnny means to draw the flower bush, but the drawing looks like a rock instead! Then Johnny goes to hide behind the flower bush. | John decide esconderse detrás de una planta con flores. Él dibuja una pista en la arena. Pero aunque John quiere dibujar la planta con flores, ¡su dibujo parece una roca! Al terminar su dibujo, John se va a esconder detrás de la planta con flores. | 0.8368000984191895 |
| ToM-scene-15-q1-reality_check | What did Johnny mean to draw? | ¿Qué quería dibujar John? | 0.8338238596916199 |
| flowerbush | A flower bush | Una planta con flores | 0.8626209497451782 |
| rocks | A rock | Una roca | 0.8629486560821533 |
| ToM-scene-15-q2-false_belief | When Alex and Beth see this clue, where will they look first for Johnny? Behind the flower bush or behind the rock? | Cuando Alex e Isabel vean esta pista, ¿dónde buscarán primero a John? ¿Detrás de la planta con flores o detrás de la roca? | 0.8377081751823425 |
| ToM-scene-15-q3-reality_check | Can you help them find where Johnny really is? | ¿Puedes ayudarles a encontrar dónde se esconde John realmente? | 0.861225962638855 |
| behind-flowerbush | Behind the flower bush | Detrás de la planta con flores | 0.7924284338951111 |
| behind-rock | Behind the rock | Detrás de la roca | 0.8469506502151489 |
| ToM-scene-15-q4-emotion_reasoning | Look, Alex and Beth found Johnny, and won the game! How do you think Alex and Beth feel about winning the game? | Mira, Alex e Isabel encontraron a John y ganaron el juego. ¿Cómo crees que se sienten Alex e Isabel por ganar el juego? | 0.8805450201034546 |
| ToM-scene-16-instruct1 | Dad tells James and Sophie to get ready for school. Dad tells them to put on their shoes. | El papá les dice a Jaime y a Sofía que se preparen para ir al colegio. El papá les dice que se pongan los zapatos. | 0.8935414552688599 |
| ToM-scene-16-instruct2 | Sophie can’t find one of her shoes! She’s looking everywhere but she can't find it. | Sofía no encuentra uno de sus zapatos. Lo está buscando por todas partes, pero no lo encuentra. | 0.8788936138153076 |
| ToM-scene-16-q1-emotion_reasoning | How does Sophie feel about losing her shoe? | ¿Cómo se siente Sofía por perder su zapato? | 0.8878542184829712 |
| ToM-scene-16-q2-emotion_reasoning | How would Sophie feel if she found her shoe? | ¿Cómo se sentiría Sofía si encontrara su zapato? | 0.8842277526855469 |
| ToM-scene-16-instruct3 | Sophie can't find her shoe because earlier in the day, when no one was looking, James played a trick on Sophie and hid her shoe in the toy box. | Sofía no encuentra su zapato porque Jaime, por hacerle una broma, se lo escondió en la caja de juguetes hace un rato cuando nadie estaba mirando. | 0.8555639386177063 |
| ToM-scene-16-instruct4 | So Sophie looks everywhere and she can’t find her shoe. Dad gets mad at Sophie, because she lost her shoe and now they are late for school. | Entonces Sofía está buscando su zapato por todas partes, pero no lo encuentra. Ahora el papá se ha enfadado con Sofía porque perdió su zapato y van tarde para el colegio. | 0.8588210344314575 |
| ToM-scene-16-q3-false_belief | Is it fair that Dad is mad at Sophie for losing her shoe? | ¿Es justo que papá se enfade con Sofía por haber perdido su zapato? | 0.8762868642807007 |
| ToM-scene-16-q4-reference | Is Dad mad at James? | ¿Está el papá enfadado con Jaime? | 0.8867907524108887 |
| ToM-scene-16-q5-reference | Is Sophie mad at James? | ¿Está Sofía enfadada con Jaime? | 0.8920401930809021 |
| ToM-scene-16-instruct5 | When James sees that Dad is mad at Sophie, he goes to the toy box and gets the shoe, and gives it back to Sophie. | Cuando Jaime ve que papá está enfadado con Sofía, va a la caja de juguetes, coge el zapato y se lo devuelve a Sofía. | 0.8812480568885803 |
| ToM-scene-16-q6-reference | Is Dad mad at Sophie now? | ¿Está el papá enfadado con Sofía ahora? | 0.8888535499572754 |
| ToM-scene-16-q7-reference | Is Dad mad at James now? | ¿Está el papá enfadado con Jaime ahora? | 0.8877357244491577 |
| ToM-scene-16-q8-reference | Is Sophie mad at James now? | ¿Está Sofía enfadada con Jaime ahora? | 0.8934757709503174 |
| ToM-scene-16-instruct6 | James tells Sophie that he’s very sorry, and Sophie and Dad forgive James. They all hug. | Jaime le pide perdón a Sofía, y Sofía y el paá perdonan a Jaime. Todos se abrazan. | 0.8779864311218262 |
| ToM-scene-17-instruct1 | This is Mika. Mika’s mom owns a bookshop, and sometimes Mika helps out. Earlier today, Mika was organizing books on tables and shelves. Mika put a very large stack of blue books on the desk, a medium-sized stack of red books on the table, and a small stack of yellow books on the shelf. | Esta es Melisa. La madre de Melisa tiene una librería y Melisa a veces la ayuda. Hace un rato, Melisa estaba organizando unos libros en las mesas y biblioteca. Melisa puso una torre muy grande de libros azules en el escritorio, una torre mediana de libros rojos en la mesa y una torre pequeña de libros amarillos en la biblioteca. | 0.7878012657165527 |
| ToM-scene-17-instruct2 | Mika’s mom just walked in. Mom asks Mika for one of the books. Mika remembers where the book is, and tells mom, “The book is in the small stack!” | La madre de Melisa acaba de entrar. La madre le pide a Melisa uno de los libros. Melisa recuerda dónde está ese libro y le dice a su mamá: "¡El libro está en la torre pequeña!". | 0.7223993539810181 |
| ToM-scene-17-q1-reference | Which stack of books will mom look in? | ¿En cual torre de libros va a buscar la mamá? | 0.6058849096298218 |
| ToM-scene-17-q2-reality_check | Which stack of books was Mika talking about? | ¿A cuál torre de libros se refería Melisa? | 0.6915737390518188 |
| bluestack | The large blue stack | La torre azul grande | 0.7307431101799011 |
| redstack | The medium sized red stack | La torre roja mediana | 0.7343116402626038 |
| yellowstack | The small yellow stack | La torre amarilla pequeña | 0.6390954852104187 |
| ToM-scene-17-q3-emotion_reasoning | Mom looks in the wrong stack of books and can’t find the book that she wanted. How do you think Mom feels about not finding the book she wanted? | La mamá busca en la torre de libros equivocada y no encuentra el libro que quería. ¿Cómo crees que se siente la mamá al no encontrar el libro que quería? | 0.6982594728469849 |
| ToM-scene-17-q4-emotion_reasoning | How do you think Mom would feel if she could find the book she wanted? | ¿Cómo crees que se sentiría la mamá si pudiera encontrar el libro que quería? | 0.885945737361908 |
| ToM-scene-18-instruct1 | George and Kat are playing together. They look outside and see a new toy shop across the street. Kat decides to go buy some new toys at the toy shop. Kat asks George what toy he would like to have, and George says he would like a new basketball. | Jorge y Catalina están jugando juntos. Miran fuera y ven una juguetería nueva al otro lado de la calle. Catalina decide ir a comprar juguetes a la juguetería. Catalina le pregunta a Jorge cuál juguete le gustaría tener y Jorge dice que le gustaría un balón de baloncesto nuevo. | 0.8854451775550842 |
| ToM-scene-18-instruct2 | While Kat is walking to the toy shop, George changes his mind and yells to Kat, “Actually, can I please have some crayons?” But Kat did not hear George ask for crayons. | Mientras Catalina caminaba a la juguetería, Jorge cambió de opinión y le gritó a Catalina: "En realidad, ¿me compras unos colores, por favor?". Pero Catalina no escuchó a Jorge pedir los colores. | 0.8065509796142578 |
| ToM-scene-18-q1-false_belief | Which toy does Kat think George wants from the toy shop? | ¿Cuál juguete cree Catalina que Jorge quiere de la juguetería? | 0.8567308187484741 |
| ToM-scene-18-instruct3 | Kat didn’t hear George say that he wanted crayons. So Kat thinks George wants a basketball. Kat goes to the toy shop, but then the shop owner says that they don’t have any basketballs! But they do have storybooks, so Kat buys a storybook for George instead. | Catalina no escuchó a Jorge decir que quería unos colores, así que Catalina piensa que Jorge quiere un balón de baloncesto. Catalina va a la juguetería, pero el dueño le dice aunque no tienen balones de baloncesto, sí tienen libros de cuentos. Catalina le compra un libro de cuentos a Jorge. | 0.7810737490653992 |
| ToM-scene-18-q2-false_belief | Does George know that Kat bought a storybook? | ¿Jorge sabe que Catalina compró un libro de cuentos? | 0.8842012882232666 |
| ToM-scene-18-q3-false_belief | What does George think Kat bought at the toy shop? | ¿Qué cree Jorge que Catalina compró en la juguetería? | 0.878395140171051 |
| basketball | A basketball | Un balón de baloncesto | 0.8582612872123718 |
| storybook | A storybook | Un libro de cuentos | 0.8606962561607361 |
| crayons | Crayons | Unos colores | 0.5094856023788452 |
| ToM-scene-18-instruct4 | Kat comes back and tells George, “I’m so sorry, I couldn’t buy you a basketball because the store didn’t have any.” | Catalina vuelve y le dice a Jorge: "Lo siento mucho, no pude comprarte un balón de baloncesto porque no los vendían en la tienda". | 0.8763049840927124 |
| ToM-scene-18-q4-reality_check | What toy does George want? | ¿Cuál juguete quiere Jorge? | 0.8860488533973694 |
| ToM-scene-18-q5-reality_check | What toy did Kat buy for George? | ¿Cuál juguete le compró Catalina a Jorge? | 0.886485755443573 |
| ToM-scene-18-instruct5 | George is very happy to play with his new storybook. | Jorge está emocionado por leer su nuevo libro de cuentos. | 0.8054346442222595 |
...
| memory-game-instruct1-heavy | This is the memory game. | This is the memory game. | 0.3883444368839264 |
...
| memory-game-instruct6-heavy | If you make a mistake, just keep going! | Si cometes un error, ¡sigue adelante! | 0.8758031129837036 |
...
| counting-2 | How many apples is this? | How many apples is this? | 0.3450237810611725 |
| ns-number-comp-1 | Which card has more apples? | Which card has more apples? | 0.33001598715782166 |
| ns-number-comp-2 | Which card has more cars? | Which card has more cars? | 0.31857219338417053 |
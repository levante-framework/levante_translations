		...
		return createApp({
			setup(){
				...
				return { files, selectedFile, loading, error, results, sortedRows,
					...
					displayLang, voiceName, loadSelected, setSort, playRow, regenAndPlay, saveRow, lastGen };
			}
		});
	}

	...
	function createVm(){
		return createApp({
			setup(){
				...
				function chooseRegen(r, choice){ const map={ default:{}, speed_0_9:{ audio_length:0.9 }, speed_0_8:{ audio_length:0.8 }, boost_style:{ style:0.2 } }; const opts=map[choice]||{}; return regenAndPlay(r, opts); }
